...
function AboutSection({ data, className = "" }) {
  return (
    <section
      className={`animate-reveal mt-6 rounded-3xl bg-white/90 p-4 shadow-card backdrop-blur-sm [animation-delay:120ms] sm:p-6 lg:flex lg:flex-col lg:justify-between lg:p-7 ${className}`}
    >
